...
class VesselNetwork():
    ...
    def populate_parameter_array(self):
        ...
        def create_vessel_parameter_df(vessel_df):
            ...
            CB_geom_params_df = pd.read_csv('label_1_edge_list_for_matrix.csv')
...
def run_image_to_model(target_input_image_path, target_output_image_path, resources_path, ilastik_path, model_path, 
    ...
    bypass_network_gen_and_just_plot_binary_volume = bypass_network_gen_and_just_plot_binary_volume
    ...
    run_circ_autogen = run_circ_autogen
